...
import 'package:task_management/features/presentation/widgets/add_task_btn.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>(debugLabel: 'addTaskFormKey');
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppBloc, AppState>(
      builder: (context, state) {
        if (state.status == AppStatus.homeScreen) {
          if (state.isEdit) {
            _openAddTaskScreen();
          }
          return PopScope(
